      ...
      appBar: AppBar(
        title: fontlgbold(
            userData != null && userData?.staff?.restaurantUsername != null
                ? '${userData?.staff?.restaurantUsername} Kitchen Side'
                : 'Kitchen Side'),
        backgroundColor: backgroundColor,
        leading: Builder(
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        ...
                        // Fetch pending orders when tab is selected
                        context
                            .read<ChefOrderProvider>()
                            .fetchOrdersByType(OrderType.pending);
                      },
                      child: Container(
                        ...
                        child: Center(
                          child: Row(
                            ...
                            children: [
                              ...
                              Consumer<ChefOrderProvider>(
                                builder: (context, provider, child) {
                                  final count = provider.pendingOrders.count;
                                  if (count > 0) {
                                    return Container(
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: const Color(0xFF229116),
                          ),
                          color: indexSelected == 3
                              ? const Color(0xFF229116)
                              : white,
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Center(
                        ...
                        return Column(
                          children: [
                            kitchenOrderingDetailWidget(
                              ...
                              indexSelected,
                              order,
                              indexSelected == 3 ? true : false,
                              indexSelected == 1
                                  ? 'kitchen_incoming_order'
                                  : indexSelected == 2
                                      ? 'kitchen_accepted_order'
                                      : 'kitchen_completed_order',
                              0,
                            ),
